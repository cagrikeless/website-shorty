<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="Shorty.home" %>
<!--
	Author: W3layouts
...
<head>
	...
	<!-- //Meta-Tags -->
	<!-- Index-Page-CSS -->
	<link rel="stylesheet" href="shoppingcart/css/style.css" type="text/css" media="all">
	...
	<!-- CSS -->
	<link rel="stylesheet" href="shoppingcart/css/font-awesome.css" type="text/css" media="all">
	<!-- //Font-Awesome-File-Links -->
</head>
<!-- //Head -->
<!-- Body -->
			...
			<div class="container">
				<div class="top-grid">
					<div class="cart-grid" id="cart-1">
						<div class="img">
							<img src="shoppingcart/images/d5.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$60.00</li>
					...
					<div class="cart-grid" id="cart-2">
						<div class="img">
							<img src="shoppingcart/images/d1.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$95.00</li>
					...
					<div class="cart-grid" id="cart-3">
						<div class="img">
							<img src="shoppingcart/images/d8.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$40.00</li>
					...
					<div class="cart-grid" id="cart-4">
						<div class="img">
							<img src="shoppingcart/images/d4.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$95.00</li>
							<li class="right-text">$195.00</li>
				...
				<div class="bot-grid">
					<div class="cart-grid" id="cart-5">
						<div class="img">
							<img src="shoppingcart/images/d7.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$20.00</li>
					...
					<div class="cart-grid" id="cart-6">
						<div class="img">
							<img src="shoppingcart/images/d3.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$50.00</li>
							<li class="right-text">$95.00</li>
					...
					<div class="cart-grid" id="cart-7">
						<div class="img">
							<img src="shoppingcart/images/d2.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$25.00</li>
					...
					<div class="cart-grid" id="cart-8">
						<div class="img">
							<img src="shoppingcart/images/d6.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$36.00</li>
